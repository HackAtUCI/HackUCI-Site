...
function AcceptedMessage() {
	return (
		<>
			...
			<h4>Communication</h4>
			<p>
				Communication during the event will primarily be done through Slack. You
				will receive an invite via email closer to the event date.
			</p>
			...
			<p>
				<a href="https://map.concept3d.com/?id=463#!ce/8403?ct/55161,27429,35849?m/367524?s/">
					Map to UCI Student Center Parking Structure
				</a>
			</p>

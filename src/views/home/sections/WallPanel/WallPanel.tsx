	...
	return (
		<Container className={styles["container"]} as="section">
			<div className={styles["intro-section"]}>
				...
				<h3>
					<span className={styles["number"]}>$4,000+</span> in Prizes
				</h3>
				<h4>Create + Connect + Inspire</h4>
				<p>
					Hack at UCI is the largest collegiate hackathon in Orange County and
					we continue expanding and improving our event every year. Our focus? -
				...
				<p>
					This year, Hack at UCI will take place the weekend of February 3rd to
					5th. The event will be 100% in-person during the day (
